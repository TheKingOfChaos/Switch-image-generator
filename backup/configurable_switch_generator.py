...
def interactive_mode():
    ...
    default_filename = f"output/{'single' if layout_type == 'single' else 'double'}_row_switch_{num_ports}p_{sfp_ports}sfp.svg"
...
def main():
    ...
    if not args.output:
        ...
        args.output = f"output/{args.layout}_row_switch_{args.ports}p_{args.sfp}sfp.svg"
