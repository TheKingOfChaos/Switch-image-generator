#!/usr/bin/env python3
"""
Test script to verify that all ports use VLAN colors regardless of status.
...
generator = SwitchSVGGenerator(
    num_ports=24,
    sfp_ports=4,
    switch_name="VLAN Colors Test Switch",
    switch_model=SwitchModel.ENTERPRISE,
    output_file="tests/output/vlan_colors_test.svg",
...
generator.save_svg()
print(f"SVG saved to tests/output/vlan_colors_test.svg")
