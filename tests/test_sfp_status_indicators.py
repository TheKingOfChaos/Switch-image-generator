#!/usr/bin/env python3
"""
Test script to verify SFP port status indicators.
...
generator = SwitchSVGGenerator(
    num_ports=24,
    sfp_ports=4,
    switch_name="SFP Status Test Switch",
    switch_model=SwitchModel.ENTERPRISE,
    output_file="tests/output/sfp_status_test.svg",
...
generator.save_svg()
print(f"SVG saved to tests/output/sfp_status_test.svg")
